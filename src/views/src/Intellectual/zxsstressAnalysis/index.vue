<template>
    <div class="capsule">
              ...
              <div class="fs18 color6 fwb">任务单位:</div>
                ...
                <div class="useNum">
                    <div style="text-align:center">
                        <img src="@/assets/user/stressed.png" alt="">
                        <div class="fs16 color9">使用设备</div>
                    </div>
                     <div>
                         <div class="fs16" style="height:50px;padding-top:30px"><span class="fs22">{{userData.relaxNum}}</span>次</div>
                        <div class="fs16 color9" style='margin-top:10px'>使用次数</div>
                    </div>
                </div>
            </div>
        ...
        <div style="display:flex">
            <div class="itemLeft">
                <img src="@/assets/user/duobianxing.png" alt="">
            </div>
            <div class="itemRight">
                <!-- 选择日期 -->
                ...
                :header-row-style="{background:'#ecfaff'}" :row-style="{height:'42px',lineHeight:'42px',fontSize:'14px'}"
                >
                   <el-table-column prop="username" width="80" label="姓名">
                    ...
                    <el-table-column prop="createTime" sortable label="检测时间" >
                    </el-table-column>
                    <el-table-column prop="userId" label="检测时长(分钟)">
                        <template slot-scope='scope'>
                            <div class="dialog">
                                <div class='lookdetail' :id='scope.row.psychologicalId'><span>3</span></div>
                            </div>
                        </template>
                    </el-table-column>
                    <el-table-column prop="mindPressure" width="80" label="压力指数">
                    </el-table-column>
                    <el-table-column prop="userId" label="详情(分钟)">
                        <template slot-scope='scope'>
                            <div class="dialog">
                                <div class='lookdetail' @click="gotodetails(scope.row.psychologicalId)"><span>查看</span></div>
                            </div>
                        </template>
                    </el-table-column>
                </el-table>
        ...
        <div class="itemBottom">
            <div class="SplitLine">
                ...
                <span style='font-size: 20px;color:#eb6100;font-weight:bold;min-width:180px;margin-left: 12px;'>精神压力分析仪</span>
                <div
                    style="width: calc(100% - 201px);height: 1px; border-top: 1px dashed #eb6100;margin: 15px 0 0 16px; ">
                </div>
            </div>
            <div class="bottomLeftS">
                <img src="@/assets/user/nerve.png" alt="">
                <img src="@/assets/user/stressful.png" alt="">
            </div>
...
import { sstressuseNum,stressusedata,stressuseTable } from '@/api/Consultant'
...
export default {
  ...
  methods: {
    ...
    getfrequency () {
      sstressuseNum(this.value).then(res => {
    ...
    getData () {           // 表格数据
      stressuseTable(this.query).then(res => {
