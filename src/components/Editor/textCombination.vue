<template>
        ...
        <div class="config-box">
          ...
          <el-select v-model="currentElement.data.font.fontFamily"
            placeholder="请选择"
          ...
          <el-row :gutter="20">
            <el-col :span="4">
              <el-color-picker v-model="currentElement.data.font.color" show-alpha></el-color-picker>
            </el-col>
            <el-col :span="20">
              <el-input v-model="currentElement.data.font.fontSize">
          ...
          <el-row :gutter="20">
            <el-col :span="24">
              <div class="btn" :class="{active: currentElement.data.font.bold}" @click="currentElement.data.font.bold = !currentElement.data.font.bold">
                <i class="iconfont icon-bold"></i>
              </div>
              <div class="btn" :class="{active: currentElement.data.font.italic}" @click="currentElement.data.font.italic = !currentElement.data.font.italic">
