      ...
      <div class="config-box">
        ...
        <el-row :gutter="20" style="margin-top: 12px;" v-show="editorSettings.parentBg === 1">
          ...
          <el-col :span="24" v-show="chartData.bgimage" style="margin-top: 16px">
            <el-button type="danger" plain @click="handleScreenBgDelete" style="width: 100%">删除</el-button>
          </el-col>
        </el-row>
      </div>
    </div>
    <div class="component-config" v-if="currentElement.w">
      <div class="panel-selector">
        <div class="radio-group">
          <div class="radio-btn" @click="thisKey='general'"
            :class="{active: thisKey=='general'}">基础
          </div>
          <div class="radio-btn" @click="thisKey='data'"
      ...
      <div class="panel" v-show="thisKey=='general'">
        ...
        <div class="config-box">
          ...
          <el-row :gutter="20">
            <el-col :span="4">
              <el-color-picker v-model="currentElement.bgcolor" show-alpha></el-color-picker>
            </el-col>
            <el-col :span="20">
              <el-input v-model="currentElement.bgcolor" readonly></el-input>
            </el-col>
          </el-row>
        </div>
        <div class="config-box">
      ...
      <div class="panel" v-show="thisKey=='data' && currentElement.data.type == 'chart'">
        <div class="config-box">
          ...
          <vue-json-editor v-if="currentElement.data.datacon.type == 'raw'"
            v-model="currentElement.data.datacon.data"
            mode="code"
            :show-btns="true"
            @json-save="handleChartDataChange">
          </vue-json-editor>
          <el-select v-if="currentElement.data.datacon.type == 'connect'"
            v-model="currentElement.data.datacon.connectId"
            placeholder="请选择"
            @change="handleChartDataChange"
            style="width: 100%; margin-bottom: 10px;">
            <el-option v-for="item in connectList" :label="item.name" :value="item.id" :key="item.id"></el-option>
          </el-select>
      ...
      <div class="panel" v-show="thisKey=='data' && currentElement.data.type == 'text'">
        <div class="config-box">
      ...
      <div class="panel" v-show="thisKey=='data' && currentElement.data.type == 'image'">
        ...
        <div class="config-box">
          ...
          <el-slider v-model="currentElement.data.datacon.opacity" :max="1" :step="0.01" show-input></el-slider>
        </div>
      </div>
      <div class="panel" v-show="thisKey=='data' && currentElement.data.type == 'border'">
        <div class="config-box">
          <div class="title">边框样式</div>
          <el-select v-model="currentElement.data.datacon.borderId"
            placeholder="请选择"
            style="width: 100%; margin-bottom: 10px;">
