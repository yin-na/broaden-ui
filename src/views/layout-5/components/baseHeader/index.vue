...
<template>
    <div class="base-nav">
        <div class="inner width100 clearfix">
            ...
            <div class="fr" style='width:71%;text-align:end;margin-right:20px'>
...
<script>
import { InteRoutes } from '@/router/wjIntervention'
...
export default {
  data () {
    return {
      href: '',
      list: InteRoutes.children.filter(item=>item.meta.exhibit),
      activeName: '',
      target: '',
      login: false
    }
