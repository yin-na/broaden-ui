    ...
    <el-dialog :visible.sync="dialog" :title="titleMap[operate]" append-to-body @close="cancel"
        ...
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="70px" inline>
            ...
            <el-form-item label="登录账号" prop="loginName">
                <el-input :disabled="operate!=='create' || operate==='view'" v-model.trim="form.loginName"
                          placeholder="请勿输入汉字"/>
            </el-form-item>
            ...
            <el-form-item label="账号状态" prop="status">
                <el-radio v-for="item in dicts" :key="item.id" v-model="form.status" :label="item.value"
                          :disabled="operate==='view'" style="width:82px">{{ item.label }}
                </el-radio>
            </el-form-item>
            ...
            <el-form-item label="所在部门">
                <treeselect v-model="form.deptId" :options="depts" :style="style" :disabled="operate==='view'"
                            placeholder="选择部门" @select="generateRole"/>
            </el-form-item>
            ...
            <el-form-item style="margin-bottom: 0px;" label="角色">
                <el-select multiple :multiple-limit="1" v-model="form.roleIds" style="width: 450px;"
                           placeholder="请先选择部门" :disabled="operate==='view'" clearable>
