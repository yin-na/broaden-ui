<template>
    <div class="Detail_warps">
        ...
        <div class="rightItem">
            ...
            <div class="lefttitle" style=" padding:40px 40px 20px 45px;">
                   ...
                   <div class="dividing-rule clearfix">
                        ...
                        <div class="scale-pd scale-pdlr">
                            <div class="gradient-box">
                                ...
                                <span class="scale-line w20 scale-line w20 bgcolora5">良好</span>
...
<script>
    ...
    import tableDetail from './compents/tableDetail'
    import { mapGetters } from 'vuex'
    import echarts from './compents/echarts'
    export default {
        components: {
            tableDetail,
            echarts
