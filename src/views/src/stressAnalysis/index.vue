    ...
    <div class="capsule">
        <div style="display: flex;">
            <div class="infomation">
                ...
                <div class="resultNum" style="display: flex;justify-content: space-evenly;margin-top:59px">
        ...
        <div style="display:flex">
            ...
            <div class="itemRight">
                ...
                <el-table :data="tableData" border style="width: 100%;min-height:246px"  :default-sort="{prop: 'date', order: 'descending'}"
                ...
                >
                    ...
                    <el-table-column prop="createTime" sortable width="190" label="检测年月" >
                    </el-table-column>
                    ...
                    <el-table-column prop="mindPressure" label="压力指数(分钟)">
                    </el-table-column>
...
import { stressTable, stressquency, stresscurve  } from '@/api/user/psyExamintion'
...
export default {
  ...
  methods: {
    ...
    getfrequency () {
      stressquency(this.value).then(res => {
   ...
   this.query.userId=this.user.userId
      stressTable(this.query).then(res => {
