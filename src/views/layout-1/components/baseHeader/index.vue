...
<template>
    <div class="base-nav">
        <div class="inner width100 clearfix">
            ...
            <div class=" width55 fr" style='text-align:end;margin-right:20px' v-if="user.roles[0].roleCode=='visitor'||user.roles[0].roleCode=='student'">
            ...
            <div class=" width55 fr" style='text-align:end;margin-right:20px' v-else-if="user.roles[0].roleCode=='counselor' ||user.roles[0].roleCode=='counselorxyl'||user.roles[0].roleCode=='healthcounselor'">
                <Menu class="" mode="horizontal" theme="primary" :active-name="activeName" style="background-color:#fff !important">
            ...
            <div class="width20 fl">
              <div v-if="token" class="btn_login">
                  <img :src="user.avatar">
                  <Dropdown>
                      <a href="javascript:void(0)" style='display: block;min-width: 70px;'>
                          {{user.username}}
