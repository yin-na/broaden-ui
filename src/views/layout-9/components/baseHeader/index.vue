...
<template>
    <div class="base-nav">
        <div class="inner width100 clearfix">
            ...
            <div class=" width55 fr" style="text-align:end;margin-right:20px">
...
<script>
import { psyResource } from '@/router/psyResource'
...
export default {
  data () {
    return {
      href: '',
      list: psyResource.children.filter(item => item.meta.exhibit),
      activeName: '',
      target: '',
      login: false
    }
