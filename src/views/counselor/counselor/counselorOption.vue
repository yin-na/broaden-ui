                ...
                <div class="filter-container">
                    <el-card :shadow="shadow" style="padding-top:20px;">
                        ...
                        >
                            ...
                            <el-col :span="24">
                                <div class="label-msg fl" :style="{borderColor: theme}">培训经历基本信息</div>
                                <div class="fr">
                                    <el-button v-if="operate != 'view'" type="text" class="fs16"
                                               @click="addCounselorExperience">添加
                                    </el-button>
                                </div>
                            </el-col>
                            <el-col :span="24" class="base-table-msg">
                                <el-table
                                        ...
                                        :border="!noBorder"
                                        stripe
                                        :data="form.counselorExperiences"
                                        :header-cell-style="{
                        ...
                        'font-size':'14px',
                                ...
                                >
                                    ...
                                    >
                                        <template slot-scope="scope">
                                            <edit-btn @click="handleUpdate(scope.row)"/>
                                            <delete-btn @click="handleDelete(scope.$index)"/>
                                        </template>
                                    </el-table-column>
                                </el-table>
                            ...
                            <el-col class="btn-style" :span="24" align="center">
                                ...
                                <el-button type="primary" v-if="operate != 'view'" @click="doSubmit"
                                           :loading="loading">确定
                                </el-button>
                            </el-col>
                        </el-form>
...
<script>
    import {
        getAllCounselorType,
        getAllLabel,
        getAllCounselorAptitude,
        getAllCounselorConsultType,
        getAllCounselorAdvisoryPeople,
        getAllCounselorSpecializeTerritory,
        getAllCity,
        getone
    } from '@/api/intervention/counselor.js'
    import { save } from '@/api/counselor/counselor.js'
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                rules1: {
                    ...
                    deptName: [
                        {required: true, message: '请输入教育经历名称', trigger: 'blur'},
        ...
        created() {
            ...
            this.getAllCity();
            //心理困惑标签
            getAllCounselorType().then(res => {
                this.dictValueList = res.data
            })
            //咨询人群
            getAllCounselorAdvisoryPeople().then(res => {
                this.peopleTypeList = res.data
            })
            //咨询方式
            getAllCounselorConsultType().then(res => {
                this.consultTypeList = res.data
            })
            //认证资质
            getAllCounselorAptitude().then(res => {
                this.aptitudeTypeList = res.data
            })
            //擅长领域
            getAllCounselorSpecializeTerritory().then(res => {
                this.specializeTerritoryList = res.data
            })
